...
public enum Rank implements StringRepresentable {
    ...
    public static final Codec<Rank> CODEC =
            StringRepresentable.fromEnum(Rank::values);
    ...
    public String getTranslationKey() { return "guzhenren.enum.cultivation.rank." + name().toLowerCase(); }
}
